...
export const DISPLAY_EMPTY_USER = 'DISPLAY_EMPTY_USER';
...
export const PROFILEIMG_LOADED = 'PROFILEIMG_LOADED';
export const PROFILEIMG_LOAD_ERROR = 'PROFILEIMG_LOAD_ERROR';
